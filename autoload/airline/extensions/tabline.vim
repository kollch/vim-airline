...
function! airline#extensions#tabline#load_theme(palette)
  ...
  let tab     = get(colors, 'airline_tab', a:palette.tabs.airline_b)
  let tabsel  = get(colors, 'airline_tabsel', a:palette.tabs.airline_y)
  let tabtype = get(colors, 'airline_tabtype', a:palette.visual.airline_a)
  let tabfill = get(colors, 'airline_tabfill', a:palette.tabs.airline_c)
  let tabmod  = get(colors, 'airline_tabmod', a:palette.tabs.airline_x)
  let tabhid  = get(colors, 'airline_tabhid', a:palette.tabs.airline_c)
  if has_key(a:palette, 'normal_modified') && has_key(a:palette.normal_modified, 'airline_c')
    let tabmodu = get(colors, 'airline_tabmod_unsel', a:palette.normal_modified.airline_c)
  else
    "Fall back to normal airline_c if modified airline_c isn't present
    let tabmodu = get(colors, 'airline_tabmod_unsel', a:palette.tabs.airline_c)
  endif
  ...
  let tabsel_right  = get(colors, 'airline_tabsel_right', a:palette.tabs.airline_y)
  let tab_right     = get(colors, 'airline_tab_right',    a:palette.tabs.airline_b)
  let tabmod_right  = get(colors, 'airline_tabmod_right', a:palette.tabs.airline_x)
  let tabhid_right  = get(colors, 'airline_tabhid_right', a:palette.tabs.airline_c)
  if has_key(a:palette, 'normal_modified') && has_key(a:palette.normal_modified, 'airline_c')
    let tabmodu_right = get(colors, 'airline_tabmod_unsel_right', a:palette.normal_modified.airline_c)
  else
    "Fall back to normal airline_c if modified airline_c isn't present
    let tabmodu_right = get(colors, 'airline_tabmod_unsel_right', a:palette.tabs.airline_c)
  endif
